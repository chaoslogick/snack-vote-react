...
class Form extends React.Component {
  render() {
    return (
      <div id="signup" className="site-bd-section site-bd-section_gray">
                ...
                <div className="grid-col grid-col_1of3">
                  <div className="media u-vr_x4">
                    ...
                    <div className="media-bd">
                      <span className="assideText">info@company.com</span>
                    </div>
                  </div>
                  <div className="media u-vr_x4">
                    <div className="media-figure">
                    ...
                    <div className="media-bd">
                      <span className="assideText">(800) 555.1234</span>
                    </div>
                  </div>
                  <div className="media u-vr_x4">
                    <div className="media-figure">
